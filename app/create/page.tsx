...
export const metadata = { title: "Create a room · dispochat" };
  ...
  return (
    <main className="flex min-h-svh items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <p className="font-subtext mt-4 text-center text-xs text-muted-foreground">
          No account needed. Share the link to invite people.
        </p>
      </div>
    </main>
  );
